...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Work History And Projects}
...
\item Tech Stack: Python, Plot.ly, Django, RabbitMQ, MQTT, VueJS, node, selenium, i18n, Docker, SisenseJS
%	Vagrant, websockets
\end{compactitem}
...
\begin{compactitem}
\item Creating an algorithm to identify and map breast cancer in stained lymph node slides
...
\begin{compactitem}
\item Completed the three course specialization in AI for Medicine from deeplearning.ai from Andrew Ng
...
\affiliation []{Fourth Brain}{in progress}
\begin{compactitem}[\null]
