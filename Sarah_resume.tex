...
\affiliation []{Fourth Brain - Machine Learning and Artificial Intelligence}{in progress}
%\begin{compactitem}[\null]
%\item Machine Learning and Artificial Intelligence
%\end{compactitem}


\affiliation []{Deeplearning.ai - AI for Medicine Specialization}{2020}
%\begin{compactitem}[\null]
%\item AI for Medicine Specialization
%\end{compactitem}

\affiliation []{Mercyhurst University}{2020}
\begin{compactitem}[\null]
\item Bachelor of Science in Anthropology
%\item Concentration in Archaeology
\end{compactitem}

\affiliation []{Udacity - Computer Vision Nanodegree}{2019}
%\begin{compactitem}[\null]
%\item Computer Vision Nanodegree
%\end{compactitem}

\affiliation []{Deeplearning.ai - Computer Vision Specialization}{2019}
%\begin{compactitem}[\null]
%\item Computer Vision Specialization
%\end{compactitem}

\affiliation []{Lambda School - Computer Science}{2017}
%\begin{compactitem}[\null]
%\item Computer Science 
%\end{compactitem}

\affiliation []{Freedom Area High School}{2007}
%\begin{compactitem}[\null]
%\item Salutatorian
%\end{compactitem}
...
\goodbreak\vspace{\secskip}\par\noindent\begin{tabularx}{\linewidth}{Xr}  
	Python, Plot.ly, Django, RabbitMQ, MQTT, VueJS, Node, Selenium, i18n, Docker, Jupyter Labs,
	Golang, SQL, Matplotlib, JavaScript, GoogleMapsAPI, git, QGIS, ROOT, LaTeX, SisenseJS
\end{tabularx}
...
\affiliation[]{Rivers Agile}{April 2019 - present}
\begin{compactitem}
