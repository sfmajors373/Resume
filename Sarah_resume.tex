...
\phone{(724) 683 - 5500}
\streetaddress{140 LaVale Drive Apt 801}
\citystatezip{Monroeville, Pa 15146}
\maketitle
...
\begin{compactitem}
\item Conducted Phase III excavation Old Vero Ice Age site
\item Prepared units for photographing, profile and topographical mapping among various other tasks
\end{compactitem}

\affiliation[Field Tech]{Christine Davis Consultants}{September 2015 - January 2016}
\begin{compactitem}
\item Conducted Phase I \& Phase II evaluations for various sites
...
\item Recorded data for test pits and historic features and mapped historic, industrial site
\end{compactitem}
...
\begin{compactitem}
\item Ran register, set up plan-o-grams, stocked merchandise, worked back-stock, executed price changes, assist with two store remodels.
\item Taught quilt classes to adults and children and promoted the stores' education program, demonstrated products.
\end{compactitem}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Education
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
